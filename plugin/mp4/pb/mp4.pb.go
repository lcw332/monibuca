...
type ReqStartRecord struct {
	...
	UseDefaultStorage bool                   `protobuf:"varint,4,opt,name=useDefaultStorage,proto3" json:"useDefaultStorage,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ReqStartRecord) GetUseDefaultStorage() bool {
	if x != nil {
		return x.UseDefaultStorage
	}
	return false
}
...
const file_mp4_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\rR\x04data\"\xb1\x01\n" +
	...
	"\x11useDefaultStorage\x18\x04 \x01(\bR\x11useDefaultStorage\"W\n" +
